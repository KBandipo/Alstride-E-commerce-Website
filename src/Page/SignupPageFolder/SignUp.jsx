...
function SignUp() {
  ...
  return (
    <>
      ...
      <div className="hidden lg:block w-[31%] bg-[url('public/image/signupBackgroundImage.svg')] bg-cover bg-center bg-no-repeat">
...
/>
          ...
          <a href="https://example.com" target="_blank" rel="noopener noreferrer">
            ...
            {/* Footer Section  */}
            <div className="flex text-[#444] text-[10px] mt-[51px] mb-[30px] space-x-[260px] ">
