    ...
    <>
      <main className="box-border flex">
        ...
        <div className="grid w-[100%] grid-rows-[auto_1fr_auto] md:w-[69%]  ">
          ...
          {/* Inner Container */}
          <div className="mx-auto mb-[100px] mt-[100px] w-[48%] md:mb-0">
            <div className="w-[100%]">
              ...
              {/* Form */}
              <form className="mx-auto mb-[145px] mt-8 w-full sm:mb-[50px] md:mb-0 md:mt-12 md:w-[79%] lg:mt-16 xl:mt-[75px]">
                <div className="relative mb-5 w-full text-[#444] md:mb-[36px]">
                  <label
                  ...
                  <span className="absolute right-[5%] top-[30%] py-3 text-[12px] font-normal leading-6 text-[#444] sm:text-[14px] md:py-[18px] lg:top-[28%] lg:text-[16px] xl:top-[30%]">
                    Show
                  </span>
                </div>
