  ...
  return (
    ...
    <div className='bg-[#F7E7CE] w-full h-[80px] flex items-center mt-[45px]'>
      <div className='flex ml-[100px]'>
        <h1 className=' font-bold text-[#444]'>
      ...
      {cartProducts.length === 0 ? (
        ...
        <>
          ...
          <button className='text-[#007074] text-[18px]'>Shipping and Return Policy</button>
           ...
           <p className='text-[#444] text-[25px] font-normal leading-[24px]'>Sub Total: ${totalItemsPrice.toFixed(2)}</p>

             {/* Display shipping fee */}
           <p className='text-[#444] text-[25px] font-normal leading-[24px]'>Shipping Fee: ${shippingFee.toFixed(2)}</p>

            {/* Display tax */}
            <p className='text-[#444] text-[25px] font-normal leading-[24px]'>Tax (10%): ${totalItemsPrice * taxRate.toFixed(2)}</p>

          {/* Display total cost */}
          <p className='text-[#444] text-[31px] font-bold leading-[40px]'>Total : ${totalCost.toFixed(2)}</p>
          </div>
          </div>
            </>
